...
export default function Navegation({hoja}){
    ...
    return(
        <header className="nav-color nav-header">
                ...
                <div className="container-fluid" >
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul className="navbar-nav">
                            <li>
                            <Link to="/characters" className={hoja === "Characters" ? "activar":"boton-inicio-home"}>Characters</Link>
                            </li>
                            <li>
                                <Link to="/contact" className={hoja === "Contact" ? "activar":"boton-inicio-home"}>Contact</Link>
                            </li>
